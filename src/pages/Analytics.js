  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-950 text-slate-800 dark:text-white p-6 md:p-10 transition-colors duration-500">
      ...
      {loading ? (
        ...
        >
          {[
            { label: "Total Tasks", value: stats.total, color: "from-indigo-100 to-indigo-200 dark:from-slate-700 dark:to-slate-600" },
            { label: "Completed", value: stats.done, color: "from-green-200 to-green-300 dark:from-green-600 dark:to-green-500" },
            { label: "In Progress", value: stats.progress, color: "from-yellow-200 to-yellow-300 dark:from-yellow-600 dark:to-yellow-500" },
            { label: "Pending", value: stats.pending, color: "from-red-200 to-red-300 dark:from-red-600 dark:to-red-500" },
          ].map((item, i) => (
            <motion.div
              key={i}
              whileHover={{ scale: 1.05 }}
              className={`rounded-2xl p-6 bg-gradient-to-br ${item.color} text-center shadow-md`}
            >
